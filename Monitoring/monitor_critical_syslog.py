...
Long Description:This Script to monitor monitor critical Syslog errors like Alerting and take action. Example: ( ospf adj flapping more than X times in Y duration, cost out the link).
Input:Syslog ID
